...
/**
 * Class to work with Camilooframework Connect packages
 *
 * @category    Mage
 * @package     Mage_Connect
...
END;
    ...
    /**
     * Creates a package that is compatible with the previous version of Camilooframework Connect Manager and saves it
     *
     * @param string $path
     * @return Mage_Connect_Package
     */
    ...
    /**
     * Generate package xml that is compatible with first version of Camilooframework Connect Manager
...
END;
     ...
     * with previous version of Camilooframework Connect Manager
     *
    ...
    */
    ...
    /**
     * Create list of all files from package.xml compatible with previous version of Camilooframework Connect Manager
     *
     * @return array
     */
