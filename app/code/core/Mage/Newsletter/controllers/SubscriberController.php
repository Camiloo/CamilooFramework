        ...
        if ($this->getRequest()->isPost() && $this->getRequest()->getPost('email')) {
            ...
            try {
                ...
                if (Mage::getStoreConfig(Mage_Newsletter_Model_Subscriber::XML_PATH_ALLOW_GUEST_SUBSCRIBE_FLAG) != 1 && 
                    ...
                    Mage::throwException($this->__('Sorry, but administrator denied subscription for guests. Please <a href="%s">register</a>.', Mage::helper('user')->getRegisterUrl()));
                }
                ...
                $ownerId = Mage::getModel('user/user')
                        ...
                        ->loadByEmail($email)
                        ->getId();
                if ($ownerId !== null && $ownerId != $userSession->getId()) {
