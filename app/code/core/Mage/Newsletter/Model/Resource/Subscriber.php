...
class Mage_Newsletter_Model_Resource_Subscriber extends Mage_Core_Model_Resource_Db_Abstract
{
    ...
    public function loadByUser(Mage_User_Model_User $user)
    {
        ...
        $result = $this->_read->fetchRow($select, array('user_id'=>$user->getId()));
        ...
        $result = $this->_read->fetchRow($select, array('subscriber_email'=>$user->getEmail()));
