...
class Mage_Connect_Helper_Data extends Mage_Core_Helper_Data
{
    ...
    /**
     * Retrieve a map to convert a channel from previous version of Camilooframework Connect Manager
     *
     * @return array
     */
    ...
    /**
     * Retrieve a map to convert a channel to previous version of Camilooframework Connect Manager
     *
     * @return array
     */
    ...
    /**
     * Convert package channel in order for it to be compatible with current version of Camilooframework Connect Manager
     *
    ...
    /**
     * Convert package channel in order for it to be compatible with previous version of Camilooframework Connect Manager
     *
     * @param string $channel
     *
     * @return string
