...
-- DROP TABLE IF EXISTS `{$this->getTable('user_entity')}`;
CREATE TABLE `{$this->getTable('user_entity')}` (
...
--  ,CONSTRAINT `FK_CUSTOMER_ENTITY_PARENT_ENTITY` FOREIGN KEY (`parent_id`) REFERENCES `{$this->getTable('user_entity')}` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='User Entityies';

-- DROP TABLE IF EXISTS `{$this->getTable('user_entity_datetime')}`;
CREATE TABLE `{$this->getTable('user_entity_datetime')}` (
  ...
  CONSTRAINT `FK_CUSTOMER_DATETIME_ENTITY` FOREIGN KEY (`entity_id`) REFERENCES `{$this->getTable('user_entity')}` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- DROP TABLE IF EXISTS `{$this->getTable('user_entity_decimal')}`;
CREATE TABLE `{$this->getTable('user_entity_decimal')}` (
  `value_id` int(11) NOT NULL auto_increment,
  `entity_type_id` smallint(8) unsigned NOT NULL default '0',
  `attribute_id` smallint(5) unsigned NOT NULL default '0',
  `store_id` smallint(5) unsigned NOT NULL default '0',
  ...
  CONSTRAINT `FK_CUSTOMER_DECIMAL_ENTITY` FOREIGN KEY (`entity_id`) REFERENCES `{$this->getTable('user_entity')}` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- DROP TABLE IF EXISTS `{$this->getTable('user_entity_int')}`;
CREATE TABLE `{$this->getTable('user_entity_int')}` (
  `value_id` int(11) NOT NULL auto_increment,
  `entity_type_id` smallint(8) unsigned NOT NULL default '0',
  `attribute_id` smallint(5) unsigned NOT NULL default '0',
  `store_id` smallint(5) unsigned NOT NULL default '0',
  ...
  CONSTRAINT `FK_CUSTOMER_INT_ENTITY` FOREIGN KEY (`entity_id`) REFERENCES `{$this->getTable('user_entity')}` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- DROP TABLE IF EXISTS `{$this->getTable('user_entity_text')}`;
CREATE TABLE `{$this->getTable('user_entity_text')}` (
  `value_id` int(11) NOT NULL auto_increment,
  `entity_type_id` smallint(8) unsigned NOT NULL default '0',
  `attribute_id` smallint(5) unsigned NOT NULL default '0',
  `store_id` smallint(5) unsigned NOT NULL default '0',
  ...
  CONSTRAINT `FK_CUSTOMER_TEXT_ENTITY` FOREIGN KEY (`entity_id`) REFERENCES `{$this->getTable('user_entity')}` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- DROP TABLE IF EXISTS `{$this->getTable('user_entity_varchar')}`;
CREATE TABLE `{$this->getTable('user_entity_varchar')}` (
  `value_id` int(11) NOT NULL auto_increment,
  `entity_type_id` smallint(8) unsigned NOT NULL default '0',
  `attribute_id` smallint(5) unsigned NOT NULL default '0',
  `store_id` smallint(5) unsigned NOT NULL default '0',
  ...
  CONSTRAINT `FK_CUSTOMER_VARCHAR_ENTITY` FOREIGN KEY (`entity_id`) REFERENCES `{$this->getTable('user_entity')}` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- DROP TABLE IF EXISTS `{$this->getTable('user_group')}`;
CREATE TABLE `{$this->getTable('user_group')}` (
...
insert into `{$this->getTable('user_group')}` (`user_group_id`,`user_group_code`,`tax_class_id`) values (0,'NOT LOGGED IN',1),(1,'General',3),(2,'Wholesale',3),(3,'Retailer',3);

-- DROP TABLE IF EXISTS `{$this->getTable('user_address_entity')}`;
CREATE TABLE `{$this->getTable('user_address_entity')}` (
  `entity_id` int(10) unsigned NOT NULL auto_increment,
  `entity_type_id` smallint(8) unsigned NOT NULL default '0',
  `attribute_set_id` smallint(5) unsigned NOT NULL default '0',
  `increment_id` varchar(50) NOT NULL default '',
  ...
  CONSTRAINT `FK_CUSTOMER_ADDRESS_CUSTOMER_ID` FOREIGN KEY (`parent_id`) REFERENCES `{$this->getTable('user_entity')}` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='User Address Entities';

-- DROP TABLE IF EXISTS `{$this->getTable('user_address_entity_datetime')}`;
CREATE TABLE `{$this->getTable('user_address_entity_datetime')}` (
  `value_id` int(11) NOT NULL auto_increment,
  `entity_type_id` smallint(8) unsigned NOT NULL default '0',
  `attribute_id` smallint(5) unsigned NOT NULL default '0',
  `store_id` smallint(5) unsigned NOT NULL default '0',
  ...
  CONSTRAINT `FK_CUSTOMER_ADDRESS_DATETIME_ENTITY` FOREIGN KEY (`entity_id`) REFERENCES `{$this->getTable('user_address_entity')}` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- DROP TABLE IF EXISTS `{$this->getTable('user_address_entity_decimal')}`;
CREATE TABLE `{$this->getTable('user_address_entity_decimal')}` (
  `value_id` int(11) NOT NULL auto_increment,
  `entity_type_id` smallint(8) unsigned NOT NULL default '0',
  `attribute_id` smallint(5) unsigned NOT NULL default '0',
  `store_id` smallint(5) unsigned NOT NULL default '0',
  ...
  CONSTRAINT `FK_CUSTOMER_ADDRESS_DECIMAL_ENTITY` FOREIGN KEY (`entity_id`) REFERENCES `{$this->getTable('user_address_entity')}` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- DROP TABLE IF EXISTS `{$this->getTable('user_address_entity_int')}`;
CREATE TABLE `{$this->getTable('user_address_entity_int')}` (
  `value_id` int(11) NOT NULL auto_increment,
  `entity_type_id` smallint(8) unsigned NOT NULL default '0',
  `attribute_id` smallint(5) unsigned NOT NULL default '0',
  `store_id` smallint(5) unsigned NOT NULL default '0',
  ...
  CONSTRAINT `FK_CUSTOMER_ADDRESS_INT_ENTITY` FOREIGN KEY (`entity_id`) REFERENCES `{$this->getTable('user_address_entity')}` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- DROP TABLE IF EXISTS `{$this->getTable('user_address_entity_text')}`;
CREATE TABLE `{$this->getTable('user_address_entity_text')}` (
  `value_id` int(11) NOT NULL auto_increment,
  `entity_type_id` smallint(8) unsigned NOT NULL default '0',
  `attribute_id` smallint(5) unsigned NOT NULL default '0',
  `store_id` smallint(5) unsigned NOT NULL default '0',
  ...
  CONSTRAINT `FK_CUSTOMER_ADDRESS_TEXT_ENTITY` FOREIGN KEY (`entity_id`) REFERENCES `{$this->getTable('user_address_entity')}` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- DROP TABLE IF EXISTS `{$this->getTable('user_address_entity_varchar')}`;
CREATE TABLE `{$this->getTable('user_address_entity_varchar')}` (
  `value_id` int(11) NOT NULL auto_increment,
  `entity_type_id` smallint(8) unsigned NOT NULL default '0',
  `attribute_id` smallint(5) unsigned NOT NULL default '0',
  `store_id` smallint(5) unsigned NOT NULL default '0',
  ...
  CONSTRAINT `FK_CUSTOMER_ADDRESS_VARCHAR_ENTITY` FOREIGN KEY (`entity_id`) REFERENCES `{$this->getTable('user_address_entity')}` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
