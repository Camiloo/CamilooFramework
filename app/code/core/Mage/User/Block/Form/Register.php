 ...
 */
class Mage_User_Block_Form_Register extends Mage_Directory_Block_Data
{
    /**
     * Address instance with data
     *
     * @var Mage_User_Model_Address
     */
    protected $_address;
     ...
     *
     * @param Mage_User_Model_Form $form
     * @return Mage_User_Block_Form_Register
     */
    public function restoreSessionData(Mage_User_Model_Form $form, $scope = null)
    {
