...
class Mage_User_Block_Widget_Name extends Mage_User_Block_Widget_Abstract
{
    ...
    /**
     * Retrieve user or user address attribute instance
     *
    ...
    {
        if ($this->getForceUseUserAttributes() || $this->getObject() instanceof Mage_User_Model_User) {
            return parent::_getAttribute($attributeCode);
        }

        return Mage::getSingleton('eav/config')->getAttribute('user_address', $attributeCode);
    }
}
