...
/**
 * User Attribute Data Factory
 *
 * @category    Mage
 * @package     Mage_User
 * @author      Camilooframework Core Team <core@magentocommerce.com>
 */
class Mage_User_Model_Attribute_Data
{
     ...
     */
    public static function factory(Mage_User_Model_Attribute $attribute, Mage_Core_Model_Abstract $entity)
    {
        /* @var $dataModel Mage_User_Model_Attribute_Data_Abstract */
        ...
        if (!empty($dataModelClass)) {
            ...
            if (empty(self::$_dataModels[$attribute->getFrontendInput()])) {
                $dataModelClass = sprintf('user/attribute_data_%s', $attribute->getFrontendInput());
                $dataModel      = Mage::getModel($dataModelClass);
