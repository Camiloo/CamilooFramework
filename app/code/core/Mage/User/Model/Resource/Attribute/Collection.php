 ...
 */
class Mage_User_Model_Resource_Attribute_Collection extends Mage_Eav_Model_Resource_Entity_Attribute_Collection
{
    /**
     * code of password hash in user's EAV tables
     */
    ...
    /**
     * Return user entity type instance
     *
     ...
     * @return Mage_User_Model_Resource_Attribute_Collection
     */
    ...
    protected function _initSelect()
    {
        ...
        $scopeDescribe  = $connection->describeTable($this->getTable('user/eav_attribute_website'));
        ...
        $select->joinLeft(
            array('scope_table' => $this->getTable('user/eav_attribute_website')),
     ...
     *
     * @return Mage_User_Model_Entity_Attribute_Collection
     */
