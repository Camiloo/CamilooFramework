 ...
 */
class Mage_User_Model_Resource_Group extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
     ...
     *
     * @return Mage_User_Model_Resource_Group
     */
    ...
    protected function _afterDelete(Mage_Core_Model_Abstract $group)
    {
        ...
        foreach ($userCollection as $user) {
            $defaultGroupId = Mage::getStoreConfig(Mage_User_Model_Group::XML_PATH_DEFAULT_ID,
                $user->getStoreId());
