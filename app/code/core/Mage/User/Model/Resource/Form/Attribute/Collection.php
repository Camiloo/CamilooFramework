 ...
 */
class Mage_User_Model_Resource_Form_Attribute_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    /**
     ...
     * @return Mage_User_Model_Resource_Form_Attribute_Collection
     */
    ...
    protected function _beforeLoad()
    {
        ...
        // add scope values
        $saDescribe = $connection->describeTable($this->getTable('user/eav_attribute_website'));
        ...
        $select->joinLeft(
            array('sa' => $this->getTable('user/eav_attribute_website')),
