 ...
 */
class Mage_User_Model_Address_Abstract extends Mage_Core_Model_Abstract
{
    protected $_eventPrefix = 'user_address';
    protected $_eventObject = 'user_address';
    /**
    ...
    public function getName()
    {
        ...
        if ($config->getAttribute('user_address', 'prefix')->getIsVisible() && $this->getPrefix()) {
            $name .= $this->getPrefix() . ' ';
        }
        $name .= $this->getFirstname();
        if ($config->getAttribute('user_address', 'middlename')->getIsVisible() && $this->getMiddlename()) {
            $name .= ' ' . $this->getMiddlename();
        }
        $name .=  ' ' . $this->getLastname();
        if ($config->getAttribute('user_address', 'suffix')->getIsVisible() && $this->getSuffix()) {
            $name .= ' ' . $this->getSuffix();
        }
        return $name;
    }
    ...
    public function format($type)
    {
        ...
        Mage::dispatchEvent('user_address_format', array('type' => $formatType, 'address' => $this));
     ...
     *
     * @return Mage_User_Model_Address_Config
     */
    public function getConfig()
    {
        return Mage::getSingleton('user/address_config');
    }
