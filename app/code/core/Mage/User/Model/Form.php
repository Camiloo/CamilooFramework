...
class Mage_User_Model_Form
{
    ...
    public function getFormCode()
    {
        if (empty($this->_formCode)) {
            Mage::throwException(Mage::helper('user')->__('Form code is not defined'));
        }
     ...
     * Return user entity type if entity type is not defined
     *
    ...
    public function getEntity()
    {
        if (is_null($this->_entity)) {
            Mage::throwException(Mage::helper('user')->__('Entity instance is not defined'));
        }
        return $this->_entity;
    }
    ...
    public function getAttributes()
    {
        if (is_null($this->_attributes)) {
            /* @var $collection Mage_User_Model_Entity_Form_Attribute_Collection */
            $collection = Mage::getResourceModel('user/form_attribute_collection');
    ...
    {
        $dataModel = Mage_User_Model_Attribute_Data::factory($attribute, $this->getEntity());
     ...
     * @return array
     */
    public function outputData($format = Mage_User_Model_Attribute_Data::OUTPUT_FORMAT_TEXT)
    {
        $data = array();
        foreach ($this->getAttributes() as $attribute) {
            if ($this->_isAttributeOmitted($attribute)) {
     ...
     *
     * @param  $setValue
     * @return bool|Mage_User_Model_Form
     */
     ...
     *
     * @param Mage_User_Model_Attribute $attribute
     * @return bool
     */
