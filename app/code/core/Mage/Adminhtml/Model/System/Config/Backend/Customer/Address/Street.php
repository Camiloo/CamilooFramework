...
/**
 * User Address Street Model
 *
 * @category   Mage
 * @package    Mage_Adminhtml
 * @author     Camilooframework Core Team <core@magentocommerce.com>
 */
class Mage_Adminhtml_Model_System_Config_Backend_User_Address_Street extends Mage_Core_Model_Config_Data
{
    /**
     * Actions after save
     *
     * @return Mage_Adminhtml_Model_System_Config_Backend_User_Address_Street
     */
