 ...
 */
class Mage_Adminhtml_Model_System_Config_Backend_User_Show_User extends Mage_Core_Model_Config_Data
{
    /**
    ...
    {
        return array(
            Mage::getSingleton('eav/config')->getAttribute('user', $this->_getAttributeCode())
        );
    }
     ...
     * Actions after save
     *
     * @return Mage_Adminhtml_Model_System_Config_Backend_User_Show_User
     */
