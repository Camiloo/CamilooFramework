 ...
 */
class Mage_Adminhtml_User_Wishlist_Product_Composite_WishlistController
    extends Mage_Adminhtml_Controller_Action
{
     ...
     *
     * @return Mage_Adminhtml_User_Wishlist_Product_Composite_WishlistController
     */
    ...
    /**
     * Ajax handler to response configuration fieldset of composite product in user's wishlist
     *
     * @return Mage_Adminhtml_User_Wishlist_Product_Composite_WishlistController
     */
    public function configureAction()
    {
        ...
        try {
            ...
            $configureResult->setCurrentUserId($this->_wishlist->getUserId());
