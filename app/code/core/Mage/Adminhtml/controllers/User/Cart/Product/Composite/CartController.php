 ...
 */
class Mage_Adminhtml_User_Cart_Product_Composite_CartController extends Mage_Adminhtml_Controller_Action
{
    /**
    ...
    /**
     * Loads user, quote and quote item by request params
     *
     * @return Mage_Adminhtml_User_Cart_Product_Composite_CartController
     */
    protected function _initData()
    {
        $userId = (int) $this->getRequest()->getParam('user_id');
        if (!$userId) {
            Mage::throwException($this->__('No user id defined.'));
        }
    ...
    /**
     * Ajax handler to response configuration fieldset of composite product in user's cart
     *
     * @return Mage_Adminhtml_User_Cart_Product_Composite_CartController
     */
    public function configureAction()
    {
        ...
        try {
            ...
            $configureResult->setCurrentUser($this->_user);
        } catch (Exception $e) {
    ...
    /**
     * Check the permission to Manage Users
     *
     * @return bool
     */
