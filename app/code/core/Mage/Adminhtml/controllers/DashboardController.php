...
class Mage_Adminhtml_DashboardController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function usersNewestAction()
    {
        $this->getResponse()->setBody($this->getLayout()->createBlock('adminhtml/dashboard_tab_users_newest')->toHtml());
    }

    public function usersMostAction()
    {
        $this->getResponse()->setBody($this->getLayout()->createBlock('adminhtml/dashboard_tab_users_most')->toHtml());
    }
