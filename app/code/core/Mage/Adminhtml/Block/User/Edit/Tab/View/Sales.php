 ...
 */
class Mage_Adminhtml_Block_User_Edit_Tab_View_Sales extends Mage_Adminhtml_Block_Template
{
    ...
    {
        parent::__construct();
        $this->setId('user_view_sales_grid');
    }
	...
	return false;
        ...
        $this->_collection = Mage::getResourceModel('sales/sale_collection')
            ->setUserFilter(Mage::registry('current_user'))
        ...
        foreach ($this->_collection as $sale) {
            if (!is_null($sale->getStoreId())) {
                ...
                $sale->setStoreName(Mage::helper('user')->__('Deleted Stores'));
            }
