 ...
 */
class Mage_Adminhtml_Block_User_Edit_Tab_Newsletter_Grid_Filter_Status extends Mage_Adminhtml_Block_Widget_Grid_Column_Filter_Select
{
    ...
    protected function _getOptions()
    {
        ...
        foreach (self::$_statuses as $code=>$label) {
            $result[] = array('value'=>$code, 'label'=>Mage::helper('user')->__($label));
        }
