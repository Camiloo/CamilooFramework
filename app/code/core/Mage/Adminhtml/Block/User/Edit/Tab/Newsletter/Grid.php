 ...
 */
class Mage_Adminhtml_Block_User_Edit_Tab_Newsletter_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    public function __construct()
    {
        ...
        $this->setEmptyText(Mage::helper('user')->__('No Newsletter Found'));
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('start_at', array(
            'header'    =>  Mage::helper('user')->__('Newsletter Start'),
            'type'      =>  'datetime',
            'align'     =>  'center',
        ...
        $this->addColumn('finish_at', array(
            'header'    =>  Mage::helper('user')->__('Newsletter Finish'),
            'type'      =>  'datetime',
            'align'     =>  'center',
        ...
        $this->addColumn('letter_sent_at', array(
            'header'    =>  Mage::helper('user')->__('Newsletter Received'),
            'type'      =>  'datetime',
            'align'     =>  'center',
        ...
        $this->addColumn('template_subject', array(
            'header'    =>  Mage::helper('user')->__('Subject'),
            'align'     =>  'center',
         ...
         $this->addColumn('status', array(
            ...
            'align'     =>  'center',
            'filter'    =>  'adminhtml/user_edit_tab_newsletter_grid_filter_status',
            'index'     => 'queue_status',
            'renderer'  =>  'adminhtml/user_edit_tab_newsletter_grid_renderer_status'
        ));
        ...
        $this->addColumn('action', array(
            ...
            'filter'    =>  false,
            'sortable'  =>  false,
            'renderer'  =>  'adminhtml/user_edit_tab_newsletter_grid_renderer_action'
        ));
