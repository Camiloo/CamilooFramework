...
/**
 * Adminhtml users wishlist grid item renderer for name/options cell
 *
 * @category   Mage
 * @package    Mage_Adminhtml
 * @author     Camilooframework Core Team <core@magentocommerce.com>
 */
class Mage_Adminhtml_Block_User_Edit_Tab_View_Grid_Renderer_Item extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    /**
     * Constructor to set default template
     *
     * @return Mage_Adminhtml_Block_User_Edit_Tab_View_Grid_Renderer_Item
     */
    protected function _construct()
    {
        parent::_construct();
        $this->setTemplate('user/edit/tab/view/grid/item.phtml');
        return $this;
    }
