...
/**
 * User address region field renderer
 *
 * @author      Camilooframework Core Team <core@magentocommerce.com>
 */
class Mage_Adminhtml_Block_User_Edit_Renderer_Region extends Mage_Adminhtml_Block_Abstract implements Varien_Data_Form_Element_Renderer_Interface
{
    /**
    ...
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $html.= '<option value="">'.Mage::helper('user')->__('Please select').'</option>';
        $html.= '</select>';
