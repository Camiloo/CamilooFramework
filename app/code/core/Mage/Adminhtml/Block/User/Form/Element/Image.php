...
/**
 * User Widget Form Image File Element Block
 *
 * @category    Mage
 * @package     Mage_Adminhtml
 * @author      Camilooframework Core Team <core@magentocommerce.com>
 */
class Mage_Adminhtml_Block_User_Form_Element_Image extends Mage_Adminhtml_Block_User_Form_Element_File
{
    /**
    ...
    protected function _getPreviewUrl()
    {
        ...
        return Mage::helper('adminhtml')->getUrl('adminhtml/user/viewfile', array(
