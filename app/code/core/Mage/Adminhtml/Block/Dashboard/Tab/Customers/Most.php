...
class Mage_Adminhtml_Block_Dashboard_Tab_Users_Most extends Mage_Adminhtml_Block_Dashboard_Grid
{

    public function __construct()
    {
        parent::__construct();
        $this->setId('usersMostGrid');
    }
    ...
    {
        return $this->getUrl('*/user/edit', array('id'=>$row->getUserId()));
    }
}
