...
/**
 * Adminhtml dashboard most recent users grid
 *
 * @category   Mage
 * @package    Mage_Adminhtml
...
class Mage_Adminhtml_Block_Dashboard_Tab_Users_Newest extends Mage_Adminhtml_Block_Dashboard_Grid
{

    public function __construct()
    {
        parent::__construct();
        $this->setId('usersNewestGrid');
    }

    protected function _prepareCollection()
    {
        $collection = Mage::getResourceModel('reports/user_collection')
            ->addUserName();
    ...
    {
        return $this->getUrl('*/user/edit', array('id'=>$row->getId()));
    }
}
