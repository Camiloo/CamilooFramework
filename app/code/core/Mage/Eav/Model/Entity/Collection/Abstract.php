...
abstract class Mage_Eav_Model_Entity_Collection_Abstract extends Varien_Data_Collection_Db
{
     ...
     *
     * Examples:
     * ('billing_firstname', 'user_address/firstname', 'default_billing')
     * ('billing_lastname', 'user_address/lastname', 'default_billing')
     * ('shipping_lastname', 'user_address/lastname', 'default_billing')
     * ('shipping_postalcode', 'user_address/postalcode', 'default_shipping')
