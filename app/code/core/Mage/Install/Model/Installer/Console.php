...
class Mage_Install_Model_Installer_Console extends Mage_Install_Model_Installer_Abstract
{
    ...
    public function setArgs($args = null)
    {
        ...
        if (!$this->_checkFlag($args['license_agreement_accepted'])) {
            $this->addError('ERROR: You have to accept Camilooframework license agreement terms and conditions to continue installation');
            return false;
        }
    ...
    public function init(Mage_Core_Model_App $app)
    {
         ...
         */
        if (Mage::isInstalled()) {
            $this->addError('ERROR: Camilooframework is already installed');
            return false;
        }
