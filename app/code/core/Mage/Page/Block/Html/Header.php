...
class Mage_Page_Block_Html_Header extends Mage_Core_Block_Template
{
    ...
    public function getWelcome()
    {
        if (empty($this->_data['welcome'])) {
            if (Mage::isInstalled() && Mage::getSingleton('user/session')->isLoggedIn()) {
                $this->_data['welcome'] = $this->__('Welcome, %s!', $this->htmlEscape(Mage::getSingleton('user/session')->getUser()->getName()));
            } else {
